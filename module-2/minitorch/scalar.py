...
class Scalar:
    ...
    def log(self) -> Scalar:
        ...
        Returns:
            Scalar: Natural logarithm of this scalar value.
    ...
    def exp(self) -> Scalar:
        ...
        Returns:
            Scalar: Exponential of this scalar value.

        """
        return Exp.apply(self)

    def sigmoid(self) -> Scalar:
        """Computes the sigmoid function (1 / (1 + e^(-x))) of this scalar.

        Returns:
            Scalar: Sigmoid of this scalar value.

        """
        return Sigmoid.apply(self)

    def relu(self) -> Scalar:
        """Computes the ReLU (Rectified Linear Unit) function of this scalar.

        Returns:
            Scalar: ReLU of this scalar value (max(0, x)).
    ...
    def is_constant(self) -> bool:
        """Check if this variable is a constant (no history).

        Returns:
            bool: True if this variable has no history, False otherwise.
    ...
    def parents(self) -> Iterable[Variable]:
        ...
        Returns:
            Iterable[Variable]: The input variables from the history.
    ...
    def chain_rule(self, d_output: Any) -> Iterable[Tuple[Variable, Any]]:
        ...
        Returns:
            Iterable[Tuple[Variable, Any]]: Pairs of (parent variable, gradient).
