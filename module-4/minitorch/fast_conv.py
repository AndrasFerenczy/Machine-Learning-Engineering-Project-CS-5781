# pyright: reportGeneralTypeIssues=false, reportOptionalCall=false, reportOptionalSubscript=false, reportArgumentType=false, reportOperatorIssue=false, reportCallIssue=false
...
class Conv1dFun(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, Tensor]:
        ...
        Args:
            ctx: Context containing saved values
            grad_output: Gradient of the output

        Returns:
            Tuple of gradients for input and weight tensors
